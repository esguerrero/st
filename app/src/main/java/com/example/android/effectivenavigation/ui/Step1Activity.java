...
public class Step1Activity extends Activity {
    ...
    //String uricntdwn= "http://www8.cs.umu.se/~esteban/vid/acountdown.mp4";
    String uricntdwn= "android.resource://com.example.android.effectivenavigation/"+R.drawable.acountdown;
...
*/
        ...
        butstart = (ImageButton) findViewById(R.id.imageButton);
...
//AfterVideo2();
        ...
        public void StartCountDownVideo(){
            videocountdown = (VideoView)findViewById(R.id.videoView);
            videocountdown.setAlpha(1.0f);
  ...
  /*
    ...
    */
            ...
            videoAfterMeas = (VideoView)findViewById(R.id.videoView);
            ...
            alertDialogBuilder.setMessage("Klarade du testet utan att förlora balansen eller ta stöd med händer eller andra kroppsdelar?")
                    ...
                    .setPositiveButton("Ja", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            Intent intent = new Intent(getApplicationContext(), FullscreenStep2.class);
