...
public class Step4Activity extends Activity {
    ...
    //String uriendbeep= "http://www8.cs.umu.se/~esteban/vid/dstop.mp4";
    String uriendbeep = "android.resource://com.example.android.effectivenavigation/"+ R.drawable.dstop;

    //String uricntdwn= "http://www8.cs.umu.se/~esteban/vid/dcountdown.mp4";
    String uricntdwn = "android.resource://com.example.android.effectivenavigation/"+R.drawable.dcountdown;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.step4, menu);
        return true;
    }
...
*/
        videointro = (VideoView)findViewById(R.id.videoViews4);
        videointro.setAlpha(0.00f);

        butstart = (ImageButton) findViewById(R.id.imageButton4);
    ...
    public void addListenerOnBackButton() {
        ...
        butiBack = (Button) findViewById(R.id.buttons4);
...
//AfterVideo2();
        ...
        public void StartCountDownVideo(){
            videocountdown = (VideoView)findViewById(R.id.videoViews4);
  ...
  /*
    ...
    */
            ...
            videoAfterMeas = (VideoView)findViewById(R.id.videoViews4);
                    ...
                    .setPositiveButton("Spara", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            for (Iterator<Measure> it = measuresList.iterator(); it.hasNext(); ) {
                                ...
                                pairs.add(new BasicNameValuePair("key6", "m4"));
