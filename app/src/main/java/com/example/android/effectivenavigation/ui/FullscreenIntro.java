 ...
 */
public class FullscreenIntro extends Activity {
    /**
    ...
    String urividintro= "android.resource://com.example.android.effectivenavigation/"+ R.drawable.introsppb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videointro = (VideoView)findViewById(R.id.videoViewx);
    ...
    public void addListenerOnButton() {
        ...
        butiBack = (Button) findViewById(R.id.dummy_button);
